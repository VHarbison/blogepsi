...
<nav class="navbar navbar-default">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="Login.do">Bienvenu</a>
        </div>

        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-expand-md">
                <li><a href="Login.do">Accueil</a></li>
            </ul>

            <ul class="nav navbar-nav navbar-right">
                <c:choose>
                    <c:when test="${ (empty user) }">
                        <li><a href="Register.do">S'enregistrer <i class="fas fa-user-plus"></i></a></li>
                        <li><a href="Login.do">Se connecter <i class="fas fa-user"></i></a></li>
                    </c:when>
                    <c:otherwise>
                        <c:set var="user" value="${user}"/>
                        <li><a href="Logout.do">deconexion  <i class="fas fa-sign-out-alt"></i></a></li>
